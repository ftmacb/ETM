...
//const CGFloat JDSideMenuDefaultMenuWidth = 160.0;
const CGFloat JDSideMenuDefaultDamping = 0.5;

#define JDSideMenuDefaultMenuWidth WIDTH*8/10
...
- (void)viewDidLoad
{
    ...
    self.contentController.view.backgroundColor = [UIColor purpleColor];
    self.contentController.view.layer.shadowOffset = CGSizeZero;
    self.contentController.view.layer.shadowOpacity = 1.0f;
    self.contentController.view.layer.shadowColor = [UIColor blackColor].CGColor;
    UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRect:self.contentController.view.bounds];
    self.contentController.view.layer.shadowPath = shadowPath.CGPath;
                     ...
                     animted:(BOOL)animated
{
    ...
    self.contentController.view.layer.shadowOpacity = 1.0f;
    self.contentController.view.layer.shadowColor = [UIColor blackColor].CGColor;
    self.contentController.view.backgroundColor = [UIColor blackColor];
    UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRect:self.contentController.view.bounds];
    self.contentController.view.layer.shadowPath = shadowPath.CGPath;
    ...
    [UIView animateWithDuration:JDSideMenuDefaultCloseAnimationTime/2.0 animations:^{
        ...
        blockSelf.containerView.backgroundColor = [UIColor blackColor];
        self.contentController.view.backgroundColor = [UIColor blackColor];
        // remove old controller
        previousController.view.superview.backgroundColor = [UIColor blackColor];
